...
class PharmacyController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        $documentCode = $this->pharmacyRepository->documentCode();
        $lastPharmacyRecord = $this->pharmacyRepository->lastPharmacyRecord();

        return view('pharmacies.create')
            ->with('documentCode', $documentCode)
            ->with('lastPharmacyRecord', $lastPharmacyRecord);
    }
