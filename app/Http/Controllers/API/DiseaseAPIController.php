...
class DiseaseAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse($diseases->toArray(), 'Diseases retrieved successfully');
    }
    ...
    public function store(CreateDiseaseAPIRequest $request)
    {
        ...
        return $this->sendResponse($disease->toArray(), 'Disease saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse($disease->toArray(), 'Disease retrieved successfully');
    }
    ...
    public function update($id, UpdateDiseaseAPIRequest $request)
    {
        ...
        return $this->sendResponse($disease->toArray(), 'Disease updated successfully');
    }
