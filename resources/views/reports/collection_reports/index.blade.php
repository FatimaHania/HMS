...
<div class="row">
    ...
    <!--filters-->
    {!! Form::open(['route' => 'collectionReport.pdf', 'id' => 'filter_form']) !!}
        ...
        <x-slot name="filters">
            <div class="form-row">
                ...
                <div class="col-md-1">
                    ...
                    <button type="button" class="btn btn-sm btn-primary pull-right" onclick="getCollections()"><i class="fa fa-search"></i> Generate</button>
                </div>
            </div>
        </x-slot>
    </x-filters.filters>
        ...
        <div class="animated fadeIn">
             ...
             <div class="card">
                <div class="card-header">
                    ...
                    <strong><span id="card_title"> Collection Report </span></strong>
                    <a href="#" onclick="generateCollectionReportPDF()" id="download_report_btn" class='btn btn-xs btn-secondary pull-right'><i class="fa fa-download" aria-hidden="true"></i> Download</a>
                </div>
                <div class="card-body">
...
<script>
    ...
    function updatePhysicianFilter() {
        ...
        var department_id = document.getElementById('filter_department').value;
            ...
            $.ajax({
            type:'POST',
            url:"{{route('collectionReport.updatePhysicianFilter')}}",
    ...
    function getCollections() {
        ...
        $.ajax({
            type:'POST',
            url:"{{route('collectionReport.getCollections')}}",
